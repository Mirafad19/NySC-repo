      ...
      <div className="mx-auto max-w-[1200px] px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/about" className="hover:text-nysc-gold">
                About NYSC
              </Link>
            </li>
            <li>
              <Link to="/top-management" className="hover:text-nysc-gold">
                Top Management
              </Link>
            </li>
            <li>
              <Link to="/departments" className="hover:text-nysc-gold">
                Departments
              </Link>
            </li>
            <li>
              <Link to="/publications" className="hover:text-nysc-gold">
                Publications
              </Link>
            </li>
            <li>
              <Link to="/faqs" className="hover:text-nysc-gold">
                FAQs
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex gap-3 mb-4">
            <a
              href="#"
              aria-label="Facebook"
              className="bg-white/10 hover:bg-nysc-gold hover:text-nysc-green-dark p-2 rounded-full transition"
            >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex gap-2">
              ...
              <span>+234 (0) 700-CALL-NYSC</span>
            </li>
            <li className="flex gap-2">
              <Mail className="h-4 w-4 mt-0.5 shrink-0" />
              <span>info@nysc.gov.ng</span>
            </li>
          </ul>
        </div>
      </div>
