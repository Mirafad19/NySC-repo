...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "History, vision, mission, and objectives of the National Youth Service Corps." },
    ],
  }),
  component: About,
});
    ...
    <PageShell title="About NYSC" subtitle="History, Vision, Mission and Objectives of the Scheme.">
      <div className="grid md:grid-cols-2 gap-10 items-start">
        <div className="space-y-4 text-neutral-700 leading-relaxed">
          ...
          <p>The National Youth Service Corps (NYSC) was established by Decree No. 24 of 22nd May, 1973 to involve Nigerian graduates in the development of the country.</p>
          <h2 className="text-2xl font-bold text-nysc-green-dark mt-6">Vision</h2>
          <p>To be a world-class national mobilisation, development and empowerment scheme that fosters national unity and integration.</p>
      ...
      <div className="mt-12">
        ...
        <ul className="grid md:grid-cols-2 gap-4">
          {[
            ...
            <li key={o} className="bg-neutral-50 border-l-4 border-nysc-green p-4 rounded">{o}</li>
          ))}
        </ul>
      </div>
    </PageShell>
