...
export const Route = createFileRoute("/nhia-enrolment")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "National Health Insurance Authority enrolment for NYSC corps members.",
      },
    ],
  }),
  component: NHIA,
...
function NHIA() {
  return (
    <PageShell
      title="NHIA Enrolment"
      subtitle="Health insurance coverage for serving corps members."
    >
      <div className="prose max-w-none text-neutral-700 space-y-4">
        <p>
          All serving corps members are enrolled in the National Health Insurance Authority (NHIA)
          scheme to ensure access to quality healthcare throughout the service year.
        </p>
