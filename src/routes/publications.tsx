...
export const Route = createFileRoute("/publications")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Official NYSC publications, reports, guidelines and downloads.",
      },
    ],
  }),
...
const PUBS = [
  "NYSC Bye-Laws",
  "Corps Member Handbook",
  "Annual Report 2023",
  "SAED Manual",
  "NDPR Audit Report 2023",
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {PUBS.map((p) => (
          <a
            key={p}
            href="#"
            className="flex items-start gap-4 p-5 bg-white border border-neutral-200 rounded-xl hover:border-nysc-green hover:shadow-md transition"
          >
