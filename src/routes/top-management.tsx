...
export const Route = createFileRoute("/top-management")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the Director-General and management team of the National Youth Service Corps." },
    ],
  }),
  component: TopMgmt,
});
    ...
    <PageShell title="Top Management" subtitle="Leadership of the National Youth Service Corps.">
      <div className="grid md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:col-span-2 space-y-4 text-neutral-700">
          ...
          <p>The DG is supported by a team of seasoned Directors heading the various departments of the Scheme.</p>
        </div>
      </div>
      <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {["Director, Corps Mobilisation","Director, Corps Welfare","Director, SAED","Director, Finance & Accounts","Director, ICT","Director, Press & PR"].map((r) => (
          <div key={r} className="bg-white border border-neutral-200 rounded-xl p-6 hover:shadow-lg transition">
